...
const baseMapStyleJson = {
  ...
  sources: [
    {
      id: 'data_source',
      url: 'https://samples.thinkgeo.com/cloud/example/data/countries.json',
      type: 'GeoJSON',
    },
  ],
  layers: [
...
let map = new ol.Map({
  ...
  view: new ol.View({
    center: ol.proj.fromLonLat([2.570481, 26.92763]),
...
let highlightLayer = new ol.layer.Vector({
  ...
  style: function (feature) {
    highlightStyle.getText().setText(stringDivider(feature.get('name'), 30, '\n'));
